...
def recommend_allocation(
    ...
    if not qqq_uptrend:
        return AllocationSignal(
            ...
            reason="QQQ is not in 20/50 uptrend.",
        )
    ...
    if qqq_dist_ma20 > 0.05 or qqq_dist_ma50 > 0.10:
        return AllocationSignal(
            ...
            reason="Uptrend exists, but QQQ is extended above moving averages.",
        )
    ...
    if rf_probability >= 0.65 and tqqq_drawdown_20d <= -0.03:
        return AllocationSignal(
            ...
            reason="Model probability is strong and TQQQ has pulled back from recent high.",
        )
    ...
    return AllocationSignal(
        ...
        max_tqqq_allocation=0.05,
        max_spy_allocation=0.60,
        reason="Trend may be positive, but model probability is weak or setup is not clean.",
    )
